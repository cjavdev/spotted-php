...
final class TracksService implements TracksContract
{
    ...
    public function list(
        ...
        return $this->listRaw($playlistID, $params, $requestOptions);
    }
    ...
    public function add(
        ...
        return $this->addRaw($playlistID, $params, $requestOptions);
    }
    ...
    public function remove(
        ...
        return $this->removeRaw($playlistID, $params, $requestOptions);
    }
