...
namespace Spotted\Chapters\ChapterListResponse;

use Spotted\AudiobookBase;
use Spotted\ChapterRestrictionObject;
use Spotted\Chapters\ChapterListResponse\Chapter\ReleaseDatePrecision;
use Spotted\Chapters\ChapterListResponse\Chapter\Type;
