...
{
    /** @use SdkModel<ChapterBulkRetrieveParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new ChapterBulkRetrieveParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ChapterBulkRetrieveParams::with(ids: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ChapterBulkRetrieveParams)->withIDs(...)
     * ```
     */
