...
{
    /** @use SdkModel<TrackBulkRetrieveParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new TrackBulkRetrieveParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TrackBulkRetrieveParams::with(ids: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new TrackBulkRetrieveParams)->withIDs(...)
     * ```
     */
