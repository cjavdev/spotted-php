 ...
 *
 * @see Spotted\Episodes->bulkRetrieve
 *
 * @phpstan-type EpisodeBulkRetrieveParamsShape = array{
 *   ids: string, market?: string
 * }
 */
final class EpisodeBulkRetrieveParams implements BaseModel
{
    /** @use SdkModel<EpisodeBulkRetrieveParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new EpisodeBulkRetrieveParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * EpisodeBulkRetrieveParams::with(ids: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new EpisodeBulkRetrieveParams)->withIDs(...)
     * ```
     */
